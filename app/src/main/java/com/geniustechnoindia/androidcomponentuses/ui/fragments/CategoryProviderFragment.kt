...
import com.geniustechnoindia.androidcomponentuses.databinding.FragmentCategoryProviderBinding
...
class CategoryProviderFragment : Fragment() {
    lateinit var binding : FragmentCategoryProviderBinding
    ...
    override fun onCreateView(
        ...
        binding= FragmentCategoryProviderBinding.inflate(inflater, container, false)
    ...
    fun getTopicList(){
        topiclist.add("Get Contact Details From Mobile")
